...
export type OrganizationProfileContentProps = {
...
export function OrganizationProfileContent({ organizationId, defaultSection = 'general', onDeleted, onLeft }: OrganizationProfileContentProps = {}) {
  const t = useT();
  ...
  const handleRemoval = (callback: OrganizationProfileContentProps['onDeleted'] | OrganizationProfileContentProps['onLeft']) => (removedOrganization: OrganizationDetails) => {
    setWasRemoved(true);
    setOrganization(null);
